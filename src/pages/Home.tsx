  ...
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        <Link
          to="/identity/create"
          className="group rounded-2xl border border-[var(--byosync-gray-200)] bg-white p-6 text-left shadow-sm transition hover:border-[var(--byosync-blue-light)] hover:shadow-lg hover:shadow-[var(--byosync-blue)]/5"
        >
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--byosync-blue-pale)] text-[var(--byosync-blue)] text-lg font-medium transition group-hover:bg-[var(--byosync-blue)] group-hover:text-white">
            +
          </span>
          <h2 className="mt-4 text-lg font-semibold text-[var(--byosync-gray-900)]">
            Create Identity
          </h2>
          <p className="mt-2 text-sm text-[var(--byosync-gray-500)]">
        ...
        >
          ...
          <p className="mt-2 text-sm text-[var(--byosync-gray-500)]">
            Enter a UUID to view metadata, status, <strong>lifecycle actions</strong>, <strong>history</strong>, and <strong>key management</strong> (list keys, rotate).
          </p>
        </Link>
      </div>

      <div className="mt-8 rounded-2xl border border-[var(--byosync-blue-pale)] bg-[var(--byosync-blue-pale)]/30 px-5 py-4 text-left">
      ...
      <p className="mt-8 text-sm text-[var(--byosync-gray-500)]">
        Identity Registry Service. Connect your backend via <code className="rounded bg-[var(--byosync-gray-100)] px-1">VITE_API_BASE</code> and <code className="rounded bg-[var(--byosync-gray-100)] px-1">VITE_API_KEY</code>.
      </p>
    </div>
  );
}
